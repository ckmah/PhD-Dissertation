...
pdf.multi_cell(0,.25, "", 0, 1)
pdf.multi_cell(0,.25, "We request permission for Michelle Franc Ragsac to use material that has been submitted for publication. Ms. Ragsac was one of the authors on this paper.", 0, 1)
pdf.multi_cell(0,.25, "", 0, 1)
